...
// var swatches = document.getElementsByclassNameName('default-swatches')[0];
...
//       <button id="spectrum-cursor" className="color-cursor"></button>
//       <canvas id="spectrum-canvas"></canvas>
//     </div>
//     <div className="hue-map">
//       <button id="hue-cursor" className="color-cursor"></button>
...
//       <label for="" className="field-label">Hex:</label>
...
//       <span id="color-indicator" className="color-indicator"></span><span>Add to Swatches</span>
//     </button>
//   </div>
// </div>
